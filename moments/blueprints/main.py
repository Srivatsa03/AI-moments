...
def generate_alt_text(image_path):
    ...
    headers = {
        'Ocp-Apim-Subscription-Key': os.getenv("AZURE_VISION_API_KEY"),
        'Content-Type': 'application/octet-stream'
    }
    params = {'visualFeatures': 'Description'}
    
    with open(image_path, 'rb') as img_data:
        response = requests.post(os.getenv("AZURE_VISION_ENDPOINT"), headers=headers, params=params, data=img_data)
...
def generate_image_tags(image_path):
    ...
    headers = {'Ocp-Apim-Subscription-Key': os.getenv("AZURE_VISION_API_KEY"), 'Content-Type': 'application/octet-stream'}
